...
Parser.prototype.write = function(chunk) {
  ...
  while (true) {
    switch (this.state) {
      ...
      case s.buffer:     this.trigger('buffer', this.num, this.buffer); break;
      case s.data:       this.trigger('data', this.num, this.buffer); break;
      case s.drained:    this.trigger('drained', this.num); break;
      case s.cancel:     this.trigger('cancel', this.num); break;
      case s.call:       this.trigger('call', this.num, this.buffer); break;
    ...
    if (this.state === s.clean) {
      ...
      switch (method) {
        ...
        case m.challenge:  this.state = s.challenge_hex; break;
        case m.solution:   this.state = s.solution_hex; break;
    ...
    switch (this.state) {
      ...
      case s.message_copy:   case s.buffer_copy:    case s.data_copy:
      case s.call_copy:
