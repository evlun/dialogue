    ...
    if (this.state === s.transition) {
      if (this.queue.length === 0) {
        ...
        if (b >= 208) {
          ...
          if      (b === 9) { this.trigger(['destroy']); }
          else if (b === 8) { this.trigger(['disconnect']); }
          else              { this.trigger(['restored']); }
          continue;
        }

        else if (b >= 3) {
          if      (b === 6) { this.out = ['solution']; }
          else if (b === 5) { this.out = ['challenge']; }
          else if (b === 4) { this.out = ['resume']; }
          else              { this.out = ['established']; }
          this.queue = [s.hex];
        }

        else {
          if      (b === 2) { this.out = ['abort']; }
          else if (b === 1) { this.out = ['secure']; }
          else              { this.out = ['connect']; }
          this.queue = [s.uint1];
        }
      }
